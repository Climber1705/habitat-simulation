...
public class WildBoar extends Animal implements Predator, Prey {
    ...
    */
    ...
    /**
    * Returns the hunting probability for the wild boar, which determines the likelihood of it hunting.
    *
    * @return The hunting probability of the wild boar as a double.
    */
