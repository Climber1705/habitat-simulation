...
public class SimulatorView extends Application {
    ...
    */
    private VBox createRightPanel() {
        ...
        rightPanel.getChildren().addAll(controlsLabel, initPopulationLabel, simulationStepsSpinner, new Separator());
        return rightPanel;
    }
    ...
    */
    private VBox createLeftPanel() {
        ...
        String POPULATION_PREFIX = "Population";
        Label populationLabel = new Label(POPULATION_PREFIX);
        populationData = new VBox();
        for (String infoString : stats.getPopulationDetails(simulator.getField())) {
            Label infoLabel = new Label(infoString);
            populationData.getChildren().add(infoLabel);
        }
    ...
    */
    ...
    /**
    * Updates the population data labels in the left panel to reflect the current population in the simulation.
    ...
    */
    private void updatePopulation() {
        Platform.runLater(() -> {
            ...
            for (String infoString : stats.getPopulationDetails(simulator.getField())) {
                populationData.getChildren().add(new Label(infoString)); // Add updated labels
            }
        });
    }
