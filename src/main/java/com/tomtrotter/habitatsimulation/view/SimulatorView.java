...
import com.tomtrotter.habitatsimulation.model.environment.FieldStats;
...
public class SimulatorView extends BaseView {
    ...
    */
    ...
    /**
    * Configures a spinner value factory for mortality rate with percent display and parsing.
    * @return SpinnerValueFactory with percentage formatting.
    */
    ...
    */
    private HBox createTopPanel() {
        ...
        settingsButton.setOnAction(_ -> viewState.switchTo(SettingsView.class));
    ...
    */
    public void updateCanvas() {
        generationLabel.setText(viewState.getGenPrefix() + viewState.getGeneration());
        updatePopulation();
        stats.reset();
    ...
    /**
    * @return Whether the simulation is currently paused.
    */
    ...
    */
    public void simulate(int numSteps) {
        ...
        new Thread(() -> {
            ...
            state.setDuration(diseaseStepsSpinner.getValue());
            state.setMortalityRate(moralityRateSpinner.getValue());
            ...
            for (int step = 0; step < numSteps && !cancelSimulation; step++) {
                ...
                Platform.runLater(() -> {
                    updateCanvas();
                    viewState.setGeneration(viewState.getGeneration() + 1);
                });
                try {
