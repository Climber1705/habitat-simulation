...
public class Tiger extends Animal implements Predator {
    ...
    * @param genetics The tiger's genetic code.
    */
    public Tiger(boolean isGen1, Field field, Location location, Color colour, Genetics genetics) {
