...
public class FoodTests {
    ...
    */
    private Tiger createYoungTiger() {
        ...
        tiger.setAge(0);
        tiger.disease.setInfected(false);
    ...
    */
    ...
    public void testYoungTigerHuntingPriority() {
        ...
        youngTiger.setAge(0);
        youngTiger.disease.setInfected(false);
        ...
        field.placeOrganism(youngTiger, youngTiger.getLocation());
        deer.setDead();
        field.removeOrganism(deer.getLocation());
    ...
    */
    ...
    public void testTigerHuntingPriority() {
        ...
        adultTiger.disease.setInfected(false);
        ...
        field.placeOrganism(adultTiger, adultTiger.getLocation());
    ...
    */
    ...
    public void testLeopardHuntingPriority() {
        ...
        adultLeopard.disease.setInfected(false);
        ...
        field.placeOrganism(adultLeopard, adultLeopard.getLocation());
    ...
    */
    ...
    public void testWildBoarHuntingPriority() {
        ...
        wildBoar.disease.setInfected(false);
        ...
        field.placeOrganism(wildBoar, wildBoar.getLocation());
        deer.setDead();
        field.removeOrganism(deer.getLocation());
        ...
        field.placeOrganism(newPlant, plant.getLocation());
