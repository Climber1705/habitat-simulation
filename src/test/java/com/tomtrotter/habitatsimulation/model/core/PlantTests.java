...
import com.tomtrotter.habitatsimulation.model.entities.Deer;
import com.tomtrotter.habitatsimulation.model.entities.Hare;
import com.tomtrotter.habitatsimulation.model.entities.Tiger;
...
public class PlantTests {
    ...
    */
    ...
    public void testNewbornReplacesPlant() {
        ...
        maleDeer.disease.setInfected(false);
        ...
        femaleDeer.disease.setInfected(false);

        field.placeOrganism(maleDeer, maleDeer.getLocation());
        field.placeOrganism(femaleDeer, femaleDeer.getLocation());
    ...
    */
    ...
    public void testAnimalDeathByOvercrowdingReplacedByPlants() {
        ...
        for (Hare hare: hares) {
            hare.disease.setInfected(false);
            field.placeOrganism(hare, hare.getLocation());
        }
    ...
    */
    ...
    public void testAnimalDeathByDiseaseReplacedByPlants() {
        ...
        Deer maleDeer = new Deer(true, field, new Location(1,1), Color.BROWN,  "13043500323040");
        maleDeer.disease.setInfected(true);
        maleDeer.genetics.setDiseaseProbability(1); // Ensures 100% chance of disease spread
        maleDeer.disease.setMortalityRate(1);

        // Simulate disease progression until death
        for(int i = 0; i < maleDeer.disease.getDuration(); i++) {
            maleDeer.disease.incrementInfected();
        }
    ...
    */
    ...
    public void testAnimalDeathByEatenNotReplacedByPlants() {
        ...
        maleTiger.disease.setInfected(false);
        
        Deer deer = new Deer(true, field, new Location(0,1), Color.BROWN,  "13043500323040");
        deer.disease.setInfected(false);
        
        field.placeOrganism(maleTiger, maleTiger.getLocation());
        field.placeOrganism(deer, deer.getLocation());
    ...
    */
    ...
    public void testPlantRemovedWhenEaten() {
        ...
        field.placeOrganism(maleDeer, maleDeer.getLocation());
        field.placeOrganism(plant, plant.getLocation());
