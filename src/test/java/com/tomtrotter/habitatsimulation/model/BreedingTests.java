...
public class BreedingTests {
    ...
    */
    private void placeAnimals() {
        ...
        field.placeAnimal(maleTiger2, maleTiger2.getLocation());
        field.placeAnimal(femaleTiger2, femaleTiger2.getLocation());

        field.placeAnimal(maleDeer1, maleDeer1.getLocation());
        field.placeAnimal(femaleDeer1, femaleDeer1.getLocation());
        field.placeAnimal(maleDeer2, maleDeer2.getLocation());
        field.placeAnimal(femaleDeer2, femaleDeer2.getLocation());
    }
